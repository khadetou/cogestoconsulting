  ...
  return (
    <section ref={scopeRef} id="home" className="hero-section relative min-h-[100svh] overflow-hidden text-white">
      ...
      <div className="hero-shell relative z-10 flex min-h-[100svh] flex-col py-5 sm:py-6 lg:py-7">
        ...
        <div className="hero-banner mt-6 flex-1 overflow-hidden rounded-[38px] border border-white/10 shadow-[0_40px_110px_rgba(0,0,0,0.28)]">
          <img
            src="/media/cogesto/buildings/glass-facade-hero.jpg"
            alt="Bâtiment illustrant l’univers de Cogesto Consulting"
          ...
          <div className="hero-banner__badge">
            <p className="text-[0.72rem] font-semibold uppercase tracking-[0.18em] text-white/52">Présence</p>
            <p className="mt-2 font-heading text-[1.55rem] leading-[1.04] tracking-[-0.05em] text-white">
              Sénégal, Maroc, Canada
            </p>
            <p className="mt-2 text-sm leading-6 text-white/60">
              Une présence internationale pour accompagner les entreprises et institutions sur leurs enjeux stratégiques et opérationnels.
            </p>
          </div>

          <div className="relative z-10 flex min-h-full flex-col justify-between px-7 pb-6 pt-8 sm:px-9 sm:pt-12 lg:px-11 lg:pb-7 lg:pt-15">
            <div className="max-w-[880px]">
              ...
              >
                ...
                <span className="mt-2 block max-w-[8ch] leading-[1.06] text-[#d9ecff] sm:mt-1 sm:max-w-[11.4ch] sm:leading-[1.12] lg:max-w-none lg:whitespace-nowrap">
            ...
            <div data-hero-item className="grid grid-cols-2 gap-3 border-t border-white/10 pt-4 sm:gap-4 sm:pt-5 lg:grid-cols-4 lg:gap-5 lg:pt-6">
              {metrics.map((metric) => {
                ...
                return (
                  ...
                  >
                    <span className="inline-flex size-10 items-center justify-center rounded-full border border-white/10 bg-white/6 text-[#d9ecff] sm:size-11">
